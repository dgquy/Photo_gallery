...
public class TrashFragment extends Fragment {
    ...
    private static final long DELETE_INTERVAL = 30 * 24 * 60 * 60 * 1000L; // 30 days in milliseconds
    ...
    private void restore(List<String> imageListPath) {
        ...
        //Toast.makeText(getContext(), urisToRemove.size(), Toast.LENGTH_SHORT).show();

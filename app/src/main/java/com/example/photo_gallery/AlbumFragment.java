...
public class AlbumFragment extends Fragment {
    ...
    private static final int REQUEST_THE_THUMBNAIL = 113;
    ...
    public void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        Toast.makeText(getContext(), requestCode + " hehe " + resultCode, Toast.LENGTH_SHORT).show();
//        if ( resultCode == Activity.RESULT_OK && requestCode == REQUEST_CODE_CREATE) {
//            eventsUpdateAlbum();
//        }
//        if (resultCode == Activity.RESULT_OK && requestCode == REQUEST_THE_THUMBNAIL) {
//            if (data != null) {
//                String thumbPath = data.getStringExtra("KEY_THUMBNAIL_RESULT");
//                Image tempImg = null;
//                for (int i = 0; i < listImage.size(); i++) {
//                    if (listImage.get(i).getThump().contains(thumbPath)) {
//                        tempImg = new Image(listImage.get(i));
//                        break;
//                    }
//                }
//
//                int posAlbum = data.getIntExtra("this_position", 0);
//                for (int i = 0; i < listAlbum.size(); i++) {
//                    if (i == posAlbum) {
//                        listAlbum.get(i).setImg(tempImg);
//                        break;
//                    }
//                }
//                Toast.makeText(getContext(), "You choose: " + thumbPath, Toast.LENGTH_SHORT).show();
//            }
//            else {
